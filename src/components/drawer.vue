<template>
  <v-navigation-drawer v-model="isDrawerVisible" :width="156" :mobile-breakpoint="1000" color="#F0F0F0 " floating>
    ...
    <div class="menu">
      <div>
        <div v-if="isAdmin || isTeacher || isOwner" class="icon-container" :class="{ 'icon-container-selected': isRouteActive('/home') }" @click="$router.push('/home')">
          <img src="@/assets/sources/icons/home.svg" alt="Home">
          <span class="w600 f14" style="color: #262262;">Home</span>
        </div>

        <div v-if="isAdmin || isOwner || isTeacher" class="icon-container mt-2" :class="{ 'icon-container-selected': isRouteActive('/home/centers') || isRouteActive('/home/new-center') || isRouteActive('/home/edit-center')}" @click="$router.push('/home/centers')">
          <img src="@/assets/sources/icons/centers.svg" alt="Centers">
          <span class="w600 f14" style="color: #262262;">Centers</span>
        </div>

        <div v-if="isAdmin || isOwner || isTeacher" class="icon-container mt-2" :class="{ 'icon-container-selected': isRouteActive('/home/students') || isRouteActive('/home/student-registration')  }" @click="$router.push('/home/students')">
          <img src="@/assets/sources/icons/students.svg" alt="Students">
          <span class="w600 f14" style="color: #262262;">Students</span>
        </div>

        <div v-if="isAdmin || isTeacher || isOwner" class="icon-container mt-2" :class="{ 'icon-container-selected': isRouteActive('/home/classrooms') || isRouteActive('/home/new-classroom') }" @click="$router.push('/home/classrooms')">
          <img src="@/assets/sources/icons/classroms.svg" alt="Classroms">
          <span class="w600 f14" style="color: #262262;">Classrooms</span>
        </div>

        <div v-if="isAdmin || isOwner || isTeacher" class="icon-container mt-2" :class="{ 'icon-container-selected': isRouteActive('/home/report') }" @click="$router.push('/home/report')">
          <img src="@/assets/sources/icons/report.svg" alt="Report">
          <span class="w600 f14" style="color: #262262;">Reports</span>
        </div>

        <div v-if="isAdmin || isOwner || isTeacher" class="icon-container mt-2" :class="{ 'icon-container-selected': isRouteActive('/home/teachers') || isRouteActive('home/new-teacher')}" @click="$router.push('/home/teachers')">
          <img src="@/assets/sources/icons/teachers.svg" alt="Teacher">
          <span class="w600 f14" style="color: #262262;">Teacher</span>
        </div>

        <div v-if="isAdmin || isOwner || isTeacher" class="icon-container mt-2" :class="{ 'icon-container-selected': isRouteActive('/home/programs') || isRouteActive('/home/additional-program') }" @click="$router.push('/home/programs')">
        ...
        <div v-if="isAdmin || isOwner || isTeacher" class="icon-container mt-2" :class="{ 'icon-container-selected': isRouteActive('/home/users') || isRouteActive('/home/users') }" @click="$router.push('/home/users')">
